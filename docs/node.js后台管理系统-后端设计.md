...
1. 在 `my_db_01` 数据库中，新建 `ev_users` 表如下：
   ![ev_users表结构](E:/SYNC(Ent)/Work/Library附件/images/1.jpg)
...
![文章分类表结构](E:/SYNC(Ent)/Work/Library附件/images/2.jpg)

#### 4.1.2 新增两条初始数据

![文章分类表结构](E:/SYNC(Ent)/Work/Library附件/images/3.jpg)
...
![ev_articles表结构](E:/SYNC(Ent)/Work/Library附件/images/4.jpg)
